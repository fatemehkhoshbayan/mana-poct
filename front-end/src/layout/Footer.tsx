...
function Footer() {
  return (
    <footer className="py-sm sm:py-lg px-lg sm:px-2xl bg-surface sticky bottom-0 z-50 flex w-full items-center justify-between border-t border-white/20">
      <div className="gap-xs text-on-surface/60 flex items-center">
